...
本作以「食堂點菜」為概念，旨在提供教練與看診者一個直覺、美觀且具備防呆機制的平台。系統能依據使用者的 **OHSA (動態姿勢評估)** 檢測結果、**慢性病禁忌**以及所選的 **OPT 訓練階段**，自動過濾食材(動作庫)，並產生專屬且安全的客製化運動菜單。
...
- **👤 權限分級與身分驗證**
  - 整合 Google OAuth，區分「系統管理員(教練)」與「一般看診者」。
  - 系統管理員能直接在系統內新增動作(食材)、刪除歷史單據。
- **🧠 智能過濾與推薦系統**
